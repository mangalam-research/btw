...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeletionChange'
        db.create_table(u'lexicography_deletionchange', (
        ...
        db.send_create_signal(u'lexicography', ['DeletionChange'])


    def backwards(self, orm):
        # Deleting model 'DeletionChange'
        db.delete_table(u'lexicography_deletionchange')
