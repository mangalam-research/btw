...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.lemma'
        db.add_column(u'lexicography_entry', 'lemma',
                      self.gf('django.db.models.fields.CharField')(default='foo', max_length=1024),
                      keep_default=False)

        # Adding field 'ChangeRecord.lemma'
        db.add_column(u'lexicography_changerecord', 'lemma',
                      self.gf('django.db.models.fields.CharField')(default='foo', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.lemma'
        db.delete_column(u'lexicography_entry', 'lemma')

        # Deleting field 'ChangeRecord.lemma'
        db.delete_column(u'lexicography_changerecord', 'lemma')
