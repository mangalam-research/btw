...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chunk.schema_version'
        db.add_column(u'lexicography_chunk', 'schema_version',
                      self.gf('django.db.models.fields.CharField')(default='0.9', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chunk.schema_version'
        db.delete_column(u'lexicography_chunk', 'schema_version')
