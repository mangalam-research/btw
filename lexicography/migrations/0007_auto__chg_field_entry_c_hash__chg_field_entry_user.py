...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lexicography_entry', 'c_hash_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['lexicography.Chunk']))

        # Changing field 'Entry.user'
        db.alter_column('lexicography_entry', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Entry.c_hash'
        db.alter_column('lexicography_entry', 'c_hash_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lexicography.Chunk'], null=True))

        # Changing field 'Entry.user'
        db.alter_column('lexicography_entry', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
