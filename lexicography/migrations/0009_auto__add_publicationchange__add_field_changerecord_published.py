...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicationChange'
        db.create_table(u'lexicography_publicationchange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changerecord', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lexicography.ChangeRecord'])),
        ...
        db.send_create_signal(u'lexicography', ['PublicationChange'])

        # Adding field 'ChangeRecord.published'
        db.add_column(u'lexicography_changerecord', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PublicationChange'
        db.delete_table(u'lexicography_publicationchange')

        # Deleting field 'ChangeRecord.published'
        db.delete_column(u'lexicography_changerecord', 'published')
