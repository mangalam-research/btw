...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Entry.headword'
        db.delete_column(u'lexicography_entry', 'headword')

        # Adding unique constraint on 'Entry', fields ['lemma']
        db.create_unique(u'lexicography_entry', ['lemma'])

        # Deleting field 'ChangeRecord.headword'
        db.delete_column(u'lexicography_changerecord', 'headword')


    def backwards(self, orm):
        # Removing unique constraint on 'Entry', fields ['lemma']
        db.delete_unique(u'lexicography_entry', ['lemma'])

        # Adding field 'Entry.headword'
        db.add_column(u'lexicography_entry', 'headword',
                      self.gf('django.db.models.fields.CharField')(default='foo', max_length=1024),
                      keep_default=False)
        ...
        # User chose to not deal with backwards NULL issues for 'ChangeRecord.headword'
        raise RuntimeError("Cannot reverse this migration. 'ChangeRecord.headword' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ChangeRecord.headword'
        db.add_column(u'lexicography_changerecord', 'headword',
    ...
    models = {
        ...
        u'lexicography.changerecord': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lemma': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
        ...
        u'lexicography.chunk': {
            ...
            '_valid': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'db_column': "'valid'", 'blank': 'True'}),
            ...
            'schema_version': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        u'lexicography.deletionchange': {
            'Meta': {'object_name': 'DeletionChange'},
            'ctype': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'entry': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lexicography.Entry']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'lexicography.entry': {
            'Meta': {'unique_together': "(('lemma',),)", 'object_name': 'Entry'},
