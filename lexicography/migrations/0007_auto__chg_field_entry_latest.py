...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lexicography_entry', 'latest_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lexicography.ChangeRecord']))
    ...
    models = {
        ...
        u'lexicography.entry': {
            ...
            'headword': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['lexicography.ChangeRecord']"})
        },
