...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.latest_published'
        db.add_column(u'lexicography_entry', 'latest_published',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['lexicography.ChangeRecord']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.latest_published'
        db.delete_column(u'lexicography_entry', 'latest_published_id')
