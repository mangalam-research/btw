...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.c_hash'
        db.alter_column(u'lexicography_entry', 'c_hash_id', self.gf(
            'django.db.models.fields.related.ForeignKey')(to=orm['lexicography.Chunk'], on_delete=models.PROTECT))

        # Changing field 'Entry.user'
        db.alter_column(u'lexicography_entry', 'user_id', self.gf(
            'django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT))

        # Changing field 'ChangeRecord.c_hash'
        db.alter_column(u'lexicography_changerecord', 'c_hash_id', self.gf(
            'django.db.models.fields.related.ForeignKey')(to=orm['lexicography.Chunk'], on_delete=models.PROTECT))

        # Changing field 'ChangeRecord.user'
        db.alter_column(u'lexicography_changerecord', 'user_id', self.gf(
            'django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Entry.c_hash'
        db.alter_column(u'lexicography_entry', 'c_hash_id', self.gf(
            'django.db.models.fields.related.ForeignKey')(to=orm['lexicography.Chunk']))
