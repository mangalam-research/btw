...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.datetime'
        db.alter_column('lexicography_entry', 'datetime', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ChangeRecord.datetime'
        db.alter_column('lexicography_changerecord', 'datetime', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Entry.datetime'
        db.alter_column('lexicography_entry', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ChangeRecord.datetime'
        db.alter_column('lexicography_changerecord', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
