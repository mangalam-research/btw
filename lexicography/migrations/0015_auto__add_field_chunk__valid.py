...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chunk._valid'
        db.add_column(u'lexicography_chunk', '_valid',
                      self.gf('django.db.models.fields.NullBooleanField')(
                          null=True, db_column='valid', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Chunk._valid'
        db.delete_column(u'lexicography_chunk', 'valid')
