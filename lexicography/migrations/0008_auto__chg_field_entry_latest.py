...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.latest'
        db.alter_column(u'lexicography_entry', 'latest_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lexicography.ChangeRecord']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Entry.latest'
        raise RuntimeError("Cannot reverse this migration. 'Entry.latest' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Entry.latest'
        db.alter_column(u'lexicography_entry', 'latest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lexicography.ChangeRecord']))
