...
PASS_THROUGH:= all test test-django test-django-menu test-django-btwredis test-karma selenium-test doc python-doc keep-latest venv dev-venv test-data shrinkwrap
